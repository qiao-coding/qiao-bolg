    ...
    <div className="p-6">
      ...
      <div className="space-y-4">
        {articles.map((article) => (
          <div 
            key={article.id}
            className="group backdrop-blur-sm rounded-lg border transition-all duration-300 cursor-pointer overflow-hidden hover:scale-102 hover:-translate-y-1 shadow-md hover:shadow-lg bg-white/60 dark:bg-gray-800/60"
          >
            <div className="p-4">
